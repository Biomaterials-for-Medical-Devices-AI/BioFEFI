...
def plot_scatter(y, yp, r2, set_name, dependent_variable, model_name):
        ...
        for model_name, model_options in opt.model_types.items():
            if model_options["use"]:
                ...
                for i in range(opt.n_bootstraps):
                    ...
                    plot_scatter(y_test[i], y_pred_test, results[i][model_name]["r2_test"], "Test", dependent_variable, model_name)
                    plot_scatter(y_train[i], y_pred_train, results[i][model_name]["r2_train"], "Train", dependent_variable, model_name)  
